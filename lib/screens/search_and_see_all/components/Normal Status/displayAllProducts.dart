...
import 'package:aakaker/screens/search_and_see_all/components/Normal%20Status/select_type1.dart';
  ...
  Widget build(BuildContext context) {
    ...
    child:
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).translate("Our Products"), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
        centerTitle: true,
        actions: <Widget>[
