...
class _BodyState extends State<Body> with TickerProviderStateMixin  {
  ...
  fetchOrders(String languageCode) async {
    //https://alsaydaly.herokuapp.com/User/OTP/+201099143706/SignUp/EN
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var apiUrl = Uri.parse("$url/User/OTP/$phoneNumber/ForgetPassword/$languageCode");
    print(apiUrl);
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                                  ...
                                  if (userOtp == code){
                                    ...
                                    Navigator.of(context).pushReplacement(
                                        MaterialPageRoute(
                                            builder:
                                                (BuildContext context) =>
                                            new RestPasswordScreen(phoneNumber: phoneNumber,
                                            )));
                  ...
                  GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      if(controller.value == 0.0){
                        ...
                        SharedPreferences prefs = await SharedPreferences.getInstance();
                        var apiUrl = Uri.parse("$url/User/OTP/$phoneNumber/ForgetPassword/${appLanguage.appLocal.languageCode}");
                        var response = await http.get(apiUrl, headers: {"authorization":prefs.getString('token')});
                        var jsonData = json.decode(response.body);
                  ...
                  //   onTap: () async {
                  //
                  //     fetchOrders(appLanguage.appLocal.languageCode);
                  //     controller.reverse(
                  //         from: controller.value == 0.0
                  //             ? 1.0
                  //             : controller.value);
